    ...
    <footer class="footer" role="contentinfo">
      <div class="container footer__container">
        <div class="footer__nav">
          ...
          <a class="footer__link" href="#tech-stack">Stack</a>
          <a class="footer__link" href="#projects">Projects</a>
          <a class="footer__link" href="#experience">Experience</a>
        ...
        <div class="footer__socials">
          ...
          <a href="https://www.linkedin.com/in/{{ contactInfo.linkedin }}" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
        ...
        <p class="footer__copyright">
          &copy; {{ year }} Esraa Ahmed Shiref. Built with Angular 21.
        </p>
